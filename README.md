...
> ⚠️ **Remarque :** La fonctionnalité de recherche automatique des visages sur le web via **PimEyes** est en cours de développement et n'est pas encore disponible dans cette version.
...
1. Clonez le dépôt
```bash
git clone https://github.com/noherb/Huginn.git
```
